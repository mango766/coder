...
replace charm.land/fantasy => github.com/kylecarbs/fantasy v0.0.0-20260318164506-15b7fa55ff50
...
require (
	...
	github.com/coder/aibridge v1.0.8-0.20260318170832-e8c551bebaba
