...
func (m queryMetricsStore) GetChatWorkspaceTTL(ctx context.Context) (int64, error) {
	start := time.Now()
...
func (m queryMetricsStore) UpsertChatWorkspaceTTL(ctx context.Context, workspaceTtl int64) error {
	start := time.Now()
