...
func (m *MockStore) GetChatWorkspaceTTL(ctx context.Context) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpsertChatWorkspaceTTL(ctx context.Context, workspaceTtl int64) error {
	m.ctrl.T.Helper()
