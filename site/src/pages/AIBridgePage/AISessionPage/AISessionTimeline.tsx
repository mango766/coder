		...
		<>
			<div className="border border-border border-solid rounded-md flex flex-col lg:flex-row gap-4 p-4">
				...
				<div className="flex-grow">
					...
					<p className="text-sm text-content-primary bg-surface-secondary leading-relaxed rounded-md p-3 overflow-auto m-0">
						{thread.prompt}
					</p>
				</div>
...
export interface AISessionTimelineProps {
	session: AIBridgeSessionThreadsResponse;
}
